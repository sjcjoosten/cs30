module CS30.Exercises.LogicRewriting.Parsing (laws, Expr (..), Op (..), Law (..), checkLaw, Equation) where
...
evalExpr (Var v)        = case v of
                           ...
                           'x' -> [True,False,True,False,True,False,True,False] -- generated by commutativity/associativity trick
